...
- 演習2： Spring Web アプリケーション（画面遷移とデータ通信） ...... p.6
  ...
  - 課題2.3：「書籍登録」のモック作成 (POST通信とFormクラス) ...... p.9
- 演習3：Spring Data JPA（データベースとの連携） ...... p.10
  - データベースのテーブル定義 ...... p.10
  - 課題3.1：エンティティクラスの作成 ...... p.11
  - 課題3.2：リポジトリインターフェースの作成 ...... p.12
  - 課題3.3：Service層の作成 ...... p.13
  - 課題3.4：全件一覧と検索モックのDB連動化 ...... p.14
  - 課題3.5：書籍詳細画面の実装（更新・削除の起点） ...... p.16
...
- 演習5：共通レイアウトの適用とデザインの統一（Thymeleaf Layout Dialect） ...... p.25
  - 課題5.1：ライブラリの導入 ...... p.25
  - 課題5.2：共通レイアウトの配置確認 ...... p.26
  - 課題5.3：全画面へのレイアウト適用（リファクタリング） ...... p.27
  - 課題5.4：動作確認 ...... p.28
  - 課題5.5：ログイン・ログアウトボタンの切り替え（th:ifの活用） ...... p.29
- 演習6：高度なデータ連携とユーザー体験の向上（動的な項目取得と0件制御） ...... p.30
  - 課題6.1：検索結果0件時の表示制御 ...... p.31
  - 課題6.2：登録画面での動的なジャンル選択（GenreServiceの作成） ...... p.32
  - 課題6.3：【発展】JPQLを用いた複合検索の実装 ...... p.33
  - 課題6.4：【オプション】更新画面への動的リスト適用 ...... p.34
- 第7章： デザインの洗練（Bootstrapの導入） ...... p.35
  - 第7章でよく使う Bootstrap クラス早見表 ...... p.36
  - 課題7.1： Bootstrap の導入と既存CSSの排除 ...... p.38
  - 課題7.2： ボタンのデザイン統一 ...... p.39
  - 課題7.3： フォーム部品の整形 ...... p.40
  - 課題7.4： テーブル（書籍一覧）の整形 ...... p.41
  - 課題7.5： 全体のレイアウト刷新 ...... p.42
