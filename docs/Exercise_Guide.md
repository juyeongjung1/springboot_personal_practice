...
- はじめに ...... p.4
- 準備：演習環境のセットアップ ...... p.5
  - 1. プロジェクトのインポート（Eclipse） ...... p.5
  - 2. データベースのセットアップ ...... p.5
- 演習2： Spring Web アプリケーション（画面遷移とデータ通信） ...... p.6
  - 課題2.1：「ログイン（トップ画面）」の作成と画面遷移 ...... p.6
  - 課題2.2：「書籍管理メニュー画面」の作成 (リンクと検索モック) ...... p.7
  - 課題2.3：「書籍登録」のモック作成 (POST通信とFormクラス) ...... p.8
- 演習3：Spring Data JPA（データベースとの連携） ...... p.9
  - データベースのテーブル定義 ...... p.9
  - 課題3.1：エンティティクラスの作成 ...... p.11
  - 課題3.2：リポジトリインターフェースの作成 ...... p.12
  - 課題3.3：Service層の作成 ...... p.13
  - 課題3.4：全件一覧と検索モックのDB連動化 ...... p.14
  - 課題3.5：書籍詳細画面の実装（更新・削除の起点） ...... p.15
  - 課題3.6：新規登録機能の実装（モックからDB保存へ） ...... p.16
  - 課題3.7：更新機能と削除機能の実装 ...... p.16
- 第4章：入力チェックとログイン認証（セッション管理） ...... p.17
  - 課題4.1：入力チェック（Validation）の実装 ...... p.17
  - 課題4.2：ユーザー管理用のEntityとRepository作成 ...... p.18
  - 課題4.3：ログイン・ログアウト機能の追加 ...... p.19
- 演習5：共通レイアウトの適用とデザインの統一（Thymeleaf Layout Dialect） ...... p.20
  - 課題5.1：ライブラリの導入 ...... p.20
  - 課題5.2：全画面へのレイアウト適用（リファクタリング） ...... p.21
  - 課題5.3：ログイン・ログアウトボタンの切り替え（th:ifの活用） ...... p.22
- 演習6：高度なデータ連携とユーザー体験の向上（動的な項目取得と0件制御） ...... p.23
  - 課題6.1：検索結果0件時の表示制御 ...... p.23
  - 課題6.2：登録画面での動的なジャンル選択（GenreServiceの作成） ...... p.24
  - 課題6.3：【発展】JPQLを用いた複合検索の実装 ...... p.25
  - 課題6.4：【オプション】更新画面への動的リスト適用 ...... p.25
- 第7章： デザインの洗練（Bootstrapの導入） ...... p.26
  - 第7章でよく使う Bootstrap クラス早見表 ...... p.27
  - 課題7.1： Bootstrap の導入と既存CSSの排除 ...... p.28
  - 課題7.2： ボタンのデザイン統一 ...... p.28
  - 課題7.3： フォーム部品の整形 ...... p.28
  - 課題7.4： テーブル（書籍一覧）の整形 ...... p.28
  - 課題7.5： 全体のレイアウト刷新 ...... p.29
