...
- はじめに ...... p.3
- 準備：演習環境のセットアップ ...... p.4
  - 1. プロジェクトのインポート（Eclipse） ...... p.4
  - 2. データベースのセットアップ ...... p.4
- 演習2： Spring Web アプリケーション（画面遷移とデータ通信） ...... p.5
  - 課題2.1：「ログイン（トップ画面）」の作成と画面遷移 ...... p.5
  - 課題2.2：「書籍管理メニュー画面」の作成 (リンクと検索モック) ...... p.6
  - 課題2.3：「書籍登録」のモック作成 (POST通信とFormクラス) ...... p.7
- 演習3：Spring Data JPA（データベースとの連携） ...... p.8
  - データベースのテーブル定義 ...... p.8
  - 課題3.1：エンティティクラスの作成 ...... p.9
  - 課題3.2：リポジトリインターフェースの作成 ...... p.10
  - 課題3.3：Service層の作成 ...... p.11
  - 課題3.4：全件一覧と検索モックのDB連動化 ...... p.12
  - 課題3.5：書籍詳細画面の実装（更新・削除の起点） ...... p.13
  - 課題3.6：新規登録機能の実装（モックからDB保存へ） ...... p.14
  - 課題3.7：更新機能と削除機能の実装 ...... p.15
- 第4章：入力チェックとログイン認証（セッション管理） ...... p.16
  - 課題4.1：入力チェック（Validation）の実装 ...... p.16
  - 課題4.2：ユーザー管理用のEntityとRepository作成 ...... p.17
  - 課題4.3：ログイン・ログアウト機能の追加 ...... p.18
- 演習5：共通レイアウトの適用とデザインの統一（Thymeleaf Layout Dialect） ...... p.19
  - 課題5.1：ライブラリの導入 ...... p.19
  - 課題5.2：共通レイアウトの配置確認 ...... p.19
  - 課題5.3：全画面へのレイアウト適用（リファクタリング） ...... p.20
  - 課題5.4：動作確認 ...... p.20
  - 課題5.5：ログイン・ログアウトボタンの切り替え（th:ifの活用） ...... p.21
- 演習6：高度なデータ連携とユーザー体験の向上（動的な項目取得と0件制御） ...... p.22
  - 課題6.1：検索結果0件時の表示制御 ...... p.22
  - 課題6.2：登録画面での動的なジャンル選択（GenreServiceの作成） ...... p.23
  - 課題6.3：【発展】JPQLを用いた複合検索の実装 ...... p.24
  - 課題6.4：【オプション】更新画面への動的リスト適用 ...... p.24
- 第7章： デザインの洗練（Bootstrapの導入） ...... p.25
  - 第7章でよく使う Bootstrap クラス早見表 ...... p.25
  - 課題7.1： Bootstrap の導入と既存CSSの排除 ...... p.26
  - 課題7.2： ボタンのデザイン統一 ...... p.26
  - 課題7.3： フォーム部品の整形 ...... p.26
  - 課題7.4： テーブル（書籍一覧）の整形 ...... p.26
  - 課題7.5： 全体のレイアウト刷新 ...... p.27
...
> [!TIP]
> **【学習のヒント：全体像の確認】**
> 実装を始める前に、各章のステップでシステムがどのように進化していくかを [書籍管理システム 補足資料（画面遷移・イメージ図・ER図）](Comprehensive_Design_Specification.md) で確認できます。スクリーンショットを通して、最終的なゴールのイメージを掴みましょう。
